...
var youtubeApi_1 = __webpack_require__(/*! ./modules/youtubeApi */ "./_dev/js/modules/youtubeApi.ts");
...
(function (win, doc) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      new accordion_1.accordion(_item5, display, footerTarget, _category);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      new categoryListAdjustment_1.categoryListAdjustment(_item6, categoryListRoots);
    }
    // アンカーリンク
  } catch (err) {
    _iterator2.e(err);
  ...
  var tabRoots = doc.querySelectorAll('[aria-controls^="tabpanel-"]');
  ...
  window.addEventListener('DOMContentLoaded', function () {
    // コンテナを指定
    var container = document.querySelector('.feather-container');
    // 羽を生成する関数
    var createFeather = function createFeather(leafClass, minSizeVal, maxSizeVal) {
      var leafEl = document.createElement('span');
      leafEl.className = "feather ".concat(leafClass);
      var minSize = minSizeVal;
      var maxSize = maxSizeVal;
      var size = Math.random() * (maxSize + 1 - minSize) + minSize;
      leafEl.style.width = "".concat(size, "px");
      leafEl.style.height = "".concat(size, "px");
      leafEl.style.left = Math.random() * 100 + '%';
      container === null || container === void 0 ? void 0 : container.appendChild(leafEl);
      // 一定時間が経てば葉っぱを消す
      setTimeout(function () {
        leafEl.remove();
      }, 8000);
    };
    var createStar = function createStar(leafClass, minSizeVal, maxSizeVal) {
      var leafEl = document.createElement('span');
      leafEl.className = "star ".concat(leafClass);
      var minSize = minSizeVal;
      var maxSize = maxSizeVal;
      var size = Math.random() * (maxSize + 1 - minSize) + minSize;
      leafEl.style.width = "".concat(size, "px");
    ...
    setInterval(createFeather.bind(_this, 'feather-1', 20, 40), 1000);
    setInterval(createFeather.bind(_this, 'feather-1', 30, 50), 2000);
    setInterval(createStar.bind(_this, 'star-1', 20, 40), 1000);
    setInterval(createStar.bind(_this, 'star-1', 20, 30), 2000);
  });
  ...
  new swiper_1["default"](".swiper-container-02", {
    modules: [modules_1.Navigation, modules_1.Pagination],
    pagination: {
      el: ".swiper-pagination",
      clickable: true
  ...
  if (xmlRoots.length) {
    ...
    try {
      for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
        ...
        var category = _item4.dataset.displayCategory;
  ...
  if (youtubeAPIRoot) {
    new youtubeApi_1.youtubeApi(youtubeAPIRoot, youtubeAPIRootLive);
  }
})(window, document);
  ...
  return _createClass(accordion, [{
    ...
    value: function fadeAnimation(target, kind) {
      ...
      if (target) {
        ...
        var _fadeAnimation = this.category === 'footer' && kind === 'open' ? target.animate({
...
var categoryListAdjustment = /*#__PURE__*/function () {
   ...
   * @returns void
   */
  return _createClass(categoryListAdjustment, [{
    key: "init",
    value: function init() {
...
var jsonGetData = /*#__PURE__*/function () {
   ...
   * @returns void
   */
  return _createClass(jsonGetData, [{
    key: "init",
    value: function init() {
...
var mvAnimation = /*#__PURE__*/function () {
   ...
   * @returns void
   */
  return _createClass(mvAnimation, [{
    key: "init",
    value: function init() {
      window.addEventListener('load', this.loadHandler.bind(this));
    }
      ...
      if (this.element.classList.contains(this.o.activeClass)) {
        ...
        setTimeout(function () {
          ...
          if (_this.targetContent) {
            ...
            _this.o.openStyle = "".concat(_this.o.toggleHeight, "px");
...
var xmlGetData = /*#__PURE__*/function () {
   ...
   * @returns void
   */
  return _createClass(xmlGetData, [{
    key: "init",
    value: function init() {
      window.addEventListener('DOMContentLoaded', this.getDataFunc.bind(this));
    }
...
var youtubeApi = /*#__PURE__*/function () {
   ...
   * @returns void
   */
  function youtubeApi(element, liveElement) {
    ...
    (_a = this.element) === null || _a === void 0 ? void 0 : _a.appendChild(this.liveRoot);
    this.reservationRoot = document.createElement('ul'); //予約ul
    this.reservationRoot.classList.add('temporary-element');
    (_b = this.liveElement) === null || _b === void 0 ? void 0 : _b.appendChild(this.reservationRoot);
    this.init();
  }
  /**
   * 初期化処理
   ...
   * @returns void
   */
  return _createClass(youtubeApi, [{
    key: "init",
    value: function init() {
    ...
    value: function onJSClientLoad() {
      var _this = this;
      var getYouTube = function getYouTube(api_1, query_1) {
        for (var _len = arguments.length, args_1 = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
          args_1[_key - 2] = arguments[_key];
        }
        return __awaiter(_this, [api_1, query_1].concat(args_1), void 0, function (api, query) {
          var _this2 = this;
          var cooldown = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 300;
          return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 2:
                  _context.next = 4;
                  return fetch("https://www.googleapis.com/youtube/v3/".concat(api).concat(Object.entries(query).reduce(function (p, _ref) {
                    var _ref2 = _slicedToArray(_ref, 2),
                      k = _ref2[0],
                      v = _ref2[1];
                    return "".concat(p, "&").concat(k, "=").concat(v);
                  }, "?key=".concat(_this2.o.APIKEY))));
                case 4:
                  _context.next = 6;
      ...
      var getVideos = function getVideos(channelId) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = _context2.t0 === this.o.CHANNEL_ID_01 ? 6 : _context2.t0 === this.o.CHANNEL_ID_02 ? 7 : _context2.t0 === this.o.CHANNEL_ID_03 ? 8 : 9;
                break;
              case 6:
      ...
      var liveStatus = function liveStatus(resolveItem, rootitems, i, detailcontent, livecontent) {
        if (resolveItem.items[0].snippet) {
          if (resolveItem.items[0].snippet.liveBroadcastContent === 'upcoming') {
            ...
            if (_this.elmCount === 1) {
              _this.reservationRoot.classList.add('youtube-list');
              _this.reservationRoot.classList.add('youtube-list--col1');
            } else if (_this.elmCount === 2) {
              _this.reservationRoot.classList.add('youtube-list');
              _this.reservationRoot.classList.remove('youtube-list--col1');
              _this.reservationRoot.classList.add('youtube-list--col2');
            } else if (_this.elmCount === 3) {
              _this.reservationRoot.classList.add('youtube-list');
              _this.reservationRoot.classList.remove('youtube-list--col2');
              _this.reservationRoot.classList.add('youtube-list--col3');
            } else if (_this.elmCount === 4) {
              _this.reservationRoot.classList.add('youtube-list');
              _this.reservationRoot.classList.remove('youtube-list--col3');
              _this.reservationRoot.classList.add('youtube-list--col4');
            }
            movieRoot.innerHTML = "<div class=\"youtube-content__items-img\">\n          <a href=\"https://www.youtube.com/watch?v=".concat(resolveItem.items[0].id, "\">\n          <img src=\"").concat(resolveItem.items[0].snippet.thumbnails.maxres.url, "\">\n          </a>\n          </div>\n        <p class=\"youtube-content__items-channel\">").concat(resolveItem.items[0].snippet.channelTitle, "</p>\n        <p class=\"youtube-content__items-text\">").concat(resolveItem.items[0].snippet.title, "</p>");
            ...
            if (_this.elmCount === 1) {
              _this.liveRoot.classList.add('youtube-list');
              _this.liveRoot.classList.add('youtube-list--col1');
            } else if (_this.elmCount === 2) {
              _this.liveRoot.classList.add('youtube-list');
              _this.liveRoot.classList.remove('youtube-list--col1');
              _this.liveRoot.classList.add('youtube-list--col2');
            } else if (_this.elmCount === 3) {
              _this.liveRoot.classList.add('youtube-list');
              _this.liveRoot.classList.remove('youtube-list--col2');
              _this.liveRoot.classList.add('youtube-list--col3');
            } else if (_this.elmCount === 4) {
              _this.liveRoot.classList.add('youtube-list');
              _this.liveRoot.classList.remove('youtube-list--col3');
              _this.liveRoot.classList.add('youtube-list--col4');
            }
      ...
      var liveDetailsFunc = function liveDetailsFunc(resolveItem, rootitems, i, detailcontent) {
        ...
        var sum = year + String(month) + String(day) + nowHour + nowMinit;
        Number(sum);
        hour = hour + 9;
        var liveTime = String(normalizeDateArry[0].split('-').join('')) + String(hour) + (minit === 0 ? '00' : String(minit));
        if (sum <= liveTime) {
